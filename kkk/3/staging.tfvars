pulse_iam = {
  ...
  roles = [
    ...
    },
    {
      ...
      policies_vars = {
        principal_services = ["ecs-tasks.amazonaws.com"]
        fargate_cluster    = "pulse-cluster"
        # Used buckets     = ["morpheus-api-files-public"]
      }
    },
    {
    ...
    },
    {
      ...
      policies_vars = {
        ...
        fargate_cluster     = "pulse-cluster"
        pulse_buckets_names = ["vas-api-files", "vas-api-files-public", "vas-api-files-quarantine"]
        sqs_queues_list     = ["platform_MedicineUsedMessage_Staging"]
        sns_subscribers_list = [
    ...
    {
      role_name        = "pulse-madcap-instance-role"
      instance_profile = true
      description      = "Pulse madcap EC2 instance role created by terraform"
      assume_policy    = "./role_policies_assume/assume-services.json"
      policies_vars = {
        principal_services = ["ec2.amazonaws.com"]
      }
    ...
    {
      role_name   = "developer-api-customExecutionRole-us-west-2-staging"
    ...
    # DMS Policies
    {
      ...
      policies_vars = {
        ...
        buckets_names      = ["vas-data-repo-raw-us-west-2-data", "vas-data-repo-raw-us-west-2-staging"] # not data-staging
      }
    },
    {
    ...
    },
    {
      ...
      policies_vars = {
        ...
        buckets_names = [
          ...
          "vas-api-files-us-west-2-staging/uploads/14/dairies",
          "vas-api-files-us-west-2-staging/temp"
        ]
    ...
    },
    {
      ...
      policies_vars = {
        ...
        source_buckets      = ["morpheus-api-files"]
        destination_buckets = ["vas-api-files-us-west-2-staging"]
      },
      role_policies = {
    ...
    },
    {
      ...
      policies_vars = {
        ...
        buckets_names      = ["vas-alta-gps-backup-staging"]
      },
      role_policies = {
  ...
  policies = [
    ...
    },
    {
      ...
      policy_vars = {
        team_name           = "integrations"
        pulse_buckets_names = ["vas-api-files", "vas-data-kpis", "vas-api-files-public"]
      }
    },
    {
  ...
  groups = [
    ...
    },
    {
      ...
      policies_vars = {
        ...
        domain_url        = "staging.integrations-vas.com",
